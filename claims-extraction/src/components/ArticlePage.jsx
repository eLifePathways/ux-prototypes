...
function StaticSection({ section, level = 2, onFigureClick }) {
  ...
  return (
    <section id={section.id}>
      ...
      {(section.children || []).map(child => (
        <StaticSection key={child.id} section={child} level={level + 1} onFigureClick={onFigureClick} />
      ))}
    </section>
  )
}
...
export default function ArticlePage({ concepts = [], versionConfig = {} }) {
  ...
  function openReference(_label) { /* no references */ }
  function openReferenceByIndex(_idx) { /* no references */ }
          ...
          <div className="article-body">
            ...
            <div className="article-content">
              ...
              {bodyArticleSections.map(section => (
                <StaticSection key={section.id} section={section} onFigureClick={openFigure} />
              ))}
            </div>
          </div>
        </div>
