...
const TIMELINE = [
  ...
  },
  {
    ...
    events: [
      { title: 'eLife Assessment updated', date: 'September 16, 2025' },
      { title: 'Peer reviews updated', date: 'September 8, 2025' },
      { title: 'Version 2 submitted', date: 'August 30, 2025' },
    ]
  },
  {
    version: 1,
    ...
    events: [
      { title: 'Author response', date: 'January 17, 2025' },
      { title: 'Peer reviewed', date: 'January 8, 2025' },
    ]
  },
  {
    version: null,
    ...
    events: [
      { title: 'Sent for peer review', date: 'December 16, 2024' },
    ]
  }
]
...
const FIGURE_IMAGE_OVERRIDES = {
  1: `${_BASE}assets/transit-2020.png`,
  2: `${_BASE}assets/figure2.png`,
  3: `${_BASE}assets/figure3.png`,
}

export default function ArticlePage({ article, concepts = [], versionConfig = {} }) {
                    ...
                    <section className="pr-section" id="pr-assessment">
                      ...
                      <div className="pr-editor-cards">
                        <div className="pr-editor-card">
                          ...
                          <span className="pr-editor-name">Jan Haaker</span>
                          <span className="pr-editor-institution">University Medical Center Hamburg-Eppendorf, Germany</span>
                        </div>
                        <div className="pr-editor-card">
                          <span className="pr-editor-role">Senior Editor</span>
                          <span className="pr-editor-name">Christian Büchel</span>
                          <span className="pr-editor-institution">University Medical Center Hamburg-Eppendorf, Germany</span>
                        </div>
                      </div>
                    </section>
                    ...
                    return (
                      <div key={i} className="version-timeline-group">
                        {isCurrent ? (
                          ...
                          <button
                            className={`version-timeline-card version-timeline-card--link${isLatest ? ' version-timeline-card--latest' : ''}`}
                            onClick={() => { window.location.href = `${import.meta.env.BASE_URL}?v=${entry.version}` }}
                          >
                            <div className="version-timeline-title">{label}</div>
                            <div className="version-timeline-date">{entry.date}</div>
                            {isLatest && <div className="version-timeline-this">Latest version</div>}
                          </button>
                        ) : (
